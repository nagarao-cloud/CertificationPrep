# CLAUDE.md — Agent context for AWS DEA-C01
...
>
> `GEMINI.md` and `AGENTS.md` in this folder are identical copies so
> that Gemini, Cursor, Copilot, and Codex pick up the same instructions.
